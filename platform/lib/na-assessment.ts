...
- Read the WHOLE crop before judging legibility, not just the first working you notice. A student's final answer is often boxed, circled, or underlined and sits below or beside earlier scratch work -- messy, crossed-out, or dense arithmetic elsewhere in the crop does not make a separate, clean, boxed final value "unclear" or "not clearly written". Scan every distinct number and expression in the image, find the one the student has marked as final (a box or circle is a strong signal), and read THAT one on its own merits. Calling a clearly legible boxed answer illegible because of what precedes it is a real error, not caution.
