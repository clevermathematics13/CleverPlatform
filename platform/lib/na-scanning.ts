...
// Paging past PostgREST's 1000-row cap; see lib/supabase-paging.ts. Kept
// importable from here for the modules that already do.
export { fetchAllRows } from "./supabase-paging";
