...
export const TOK_PROVOCATION_RULES: readonly string[] = [
  "T1. ANCHOR EACH PROVOCATION IN THIS PACKET'S OWN MATHEMATICS. Each of the two must name something the student actually meets here: the identity proved in Part 3, the assumption the model in Part 4 rests on, the definition that makes Part 1 possible, the quantity Q7 asks for. Name it in the provocation itself, in words a student who has read only this packet can follow. A provocation that names nothing from the packet is a decoration -- delete it and write one that does. Name the OBJECT, never its value: see T9, which governs what you are allowed to say about a result the student has not reached yet.",
  ...
  "T9. THE PROVOCATIONS ARE PRINTED BEFORE ANY OF THE WORK IS DONE, SO THEY MAY NOT CONTAIN ITS ANSWERS. They sit above Part 0, and the student reads them on the way in. Pointing forward is good -- 'the p-value you will calculate in Part 3', 'the two proofs you will give in Part 4' tells them where the tension will bite. Stating the RESULT is not: 'the p-value of 0.0228 you will calculate in Part 3' prints the answer to Part 3 on page 1 and turns the TOK box into an answer key. So anchor on what the packet GIVES (the machine's designed mean of 500 grams, the definition, the assumption, the question being asked) and on the NAME of what the student will produce, never on the value they are meant to produce. The same goes for the Reflection return and the T7 tie-backs -- those sit after the work, so they may cite the result, and should.",
] as const;
