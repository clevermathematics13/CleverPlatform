      ...
      <header className="mb-4">
        ...
        <div className="border-t border-gray-400 pt-3 mt-2 text-center">
          ...
          <input
            ...
            className="block w-full text-center text-[20pt] font-bold text-gray-900 border-0 border-b-2 border-transparent hover:border-blue-300 focus:border-blue-500 p-0 bg-transparent focus:outline-none focus:ring-0 mt-1 transition-colors cursor-text"
      ...
      {draft.instructions?.length > 0 && (
        <section className="mb-4">
          ...
          <ol className="list-decimal list-outside ml-5 space-y-0.5 text-[10.5pt]">
            {draft.instructions.map((ins: string, i: number) => <li key={i} className="text-gray-800">{ins}</li>)}
          </ol>
        </section>
      )}
          ...
          <section key={si} className="mt-5">
            <div className="border-t-2 border-gray-800 pt-2 mb-3 flex items-center gap-2">
              <input
                ...
                className="flex-1 border-0 p-0 bg-transparent text-[13pt] font-bold text-gray-900 focus:outline-none focus:ring-0 hover:border-b hover:border-blue-300 focus:border-b focus:border-blue-500 transition-colors cursor-text"
                style={{ fontFamily: "Georgia, serif" }}
              />
                      ...
                      <div className="mt-1 space-y-2">
                        {nq.subparts.map((sub, subi) => (
                          <QuestionRow
                            ...
                            indent={true} includeMarksColumn={formatting.includeMarksColumn ?? true}
      ...
      {formatting.includeAnswerKey && (
        <section className="mt-6 border-t-2 border-gray-800 pt-3">
          ...
          <div className="space-y-1 text-[9.5pt] text-gray-800">
            {draft.sections.flatMap((sec: AssignmentDraft["sections"][number], si: number) =>
              sec.questions.map((q: AssignmentDraft["sections"][number]["questions"][number], qi: number) => {
