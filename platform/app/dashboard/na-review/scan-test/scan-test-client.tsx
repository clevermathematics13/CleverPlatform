...
export function ScanTestClient({ versions }: { versions: PacketVersionOption[] }) {
  ...
  // a chance to re-derive it from na_packet_scans. Ported from PR #34.
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="h-2.5 flex-1 overflow-hidden rounded-full bg-da-border/40">
                    <div className="h-full rounded-full bg-da-accent transition-all" style={{ width: `${overallPct}%` }} />
                  </div>
                  <span className="font-mono text-sm font-bold text-da-text" title="Approximate: cropping counts as the first half, assessing as the second">
                    {overallPct}%
                  </span>
                </div>
